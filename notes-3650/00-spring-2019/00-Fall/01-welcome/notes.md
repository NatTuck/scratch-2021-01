...
## Course Resources
 ...
 - My site: http://ccs.neu.edu/home/ntuck/
...
## Syllabus
 ...
 - I'm teaching one section, this one.
 - There are three other sections, so we've got a big TA pool if
   you need help.
 - There's a schedule. It may resemble what happens.
 - Recommended Textbook: Useful for first half of semester.
 - Grades: Assignments.
